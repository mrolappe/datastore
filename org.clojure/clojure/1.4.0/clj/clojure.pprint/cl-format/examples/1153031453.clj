...
(cl-format nil "Pad with leading zeros ~5,'0d" 3)
;; => "Pad with leading zeros 00003"

(cl-format nil "Pad with leading asterisks ~5,'*d" 3)
...
(cl-format nil "~15a" (cl-format nil "~:d" 1234567))
;; => "1,234,567      "

(cl-format nil "Always print the sign ~5@d" 3)
;; => "Always print the sign    +3"

(cl-format nil "Use comma group-separator every 3 digits ~12:d" 1234567)
...
(cl-format nil "base 7  ~7r  with width and zero pad  ~7,15,'0r" 63 63)
;; => "base 7  120  with width and zero pad  000000000000120"

;; No need for you to do any conversions to use cl-format with BigInt,
;; BigInteger, or BigDecimal.
(cl-format nil "cl-format handles BigInts ~15d" 12345678901234567890)
;; => "cl-format handles BigInts 12345678901234567890"

(cl-format nil "Be aware of auto-conversion  ~8,'0d  ~8,'0d" 2.4 -5/4)
