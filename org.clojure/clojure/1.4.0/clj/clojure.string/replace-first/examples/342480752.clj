(require '[clojure.string :only [replace-first]])
;; => nil

;; Only replace the first match.
(replace-first "A good day to you, sir.  Good day." #"day" "night")
;; => "A good night to you, sir.  Good day."

;; If there are no matches, return the original string.
(replace-first "A good day to you, sir." #"madam" "master")
...
(replace-first "Day need not be SHOUTED." #"(?i)day" "night")
