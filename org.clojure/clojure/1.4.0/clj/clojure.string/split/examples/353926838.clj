...
;; strings.
(split "root::0:0:admin:/var/root:" #":" 2)
;; => ["root" ":0:0:admin:/var/root:"]

(split "root::0:0:admin:/var/root:" #":" 3)
;; => ["root" "" "0:0:admin:/var/root:"]

(split "root::0:0:admin:/var/root:" #":" 4)
;; => ["root" "" "0" "0:admin:/var/root:"]

(split "root::0:0:admin:/var/root:" #":" 15)
;; => ["root" "" "0" "0" "admin" "/var/root" ""]
