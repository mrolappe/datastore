...
(defn create-event-element [delayed-event tme]
  (struct event delayed-event tme))
;; => #'user/create-event-element

(defn comp-queue [e1 e2]
  (if (< (:time e1) (:time e2))
    true false))
;; => #'user/comp-queue
...
(defn create-event-queue [comp-queue size]
  (new PriorityBlockingQueue size (comp comp-queue)))
;; => #'user/create-event-queue

(def queue (create-event-queue comp-queue 10))
;; => #'user/queue
...
elements  
;; => ({:object #<Delay@37a63e06: 16>, :time 0.48566816399656854}
;; {:object #<Delay@3321875: 19>, :time 0.9374202154797486}
;; {:object #<Delay@4de3aaf6: 17>, :time 0.3271116626875401}
;; {:object #<Delay@1ded246d: 15>, :time 0.8843712542267577}
;; {:object #<Delay@3bf27f74: 10>, :time 0.86383171974926}
;; {:object #<Delay@2d8db76b: 14>, :time 0.2120086056700251}
;; {:object #<Delay@3304e92a: 5>, :time 0.9406336968276247}
;; {:object #<Delay@767de91: 0>, :time 0.2150071400135528}
;; {:object #<Delay@34450563: 7>, :time 0.7520042839572664}
