;; This example converts what would be comma-separated values into pipe '|'
;; separated values for alternate database loads. By
;; switching delimiters, quotes can be eliminated from each sequence element, which are not needed
;; for some databases.
